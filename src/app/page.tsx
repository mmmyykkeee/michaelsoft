  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-center p-8 text-center" id="app">
      ...
      <div className="hero max-w-[1200px] w-full">
        <h1 className="font-headline text-[clamp(2.5rem,8vw,8.5rem)] font-extrabold tracking-tightest uppercase mb-[-1rem] drop-shadow-2xl animate-radial-glow bg-clip-text text-transparent bg-[radial-gradient(circle_at_50%_50%,var(--color-primary)_0%,#4e8cff_30%,var(--color-secondary)_60%,var(--color-tertiary)_100%)] max-[768px]:text-[3.2rem] max-[768px]:mb-[-0.5rem] leading-[1.1] whitespace-nowrap">
          MichaelSoft
        </h1>
